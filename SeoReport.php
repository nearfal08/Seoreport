...
// 			$htmlInfo["brokenLinkCount"] = $this->getBrokenLinkCount($anchors);
	...
	function formatCheckLinks($link){
		...
		if (strpos($cssFile, '.min.') !== false) {
			return true;
		} else if (strpos($cssFile, '-min.') !== false) {
			return true;
		} else {
			return false;
		}
	...
	function getReadyHTML($htmlInfo){
		...
		$html = '<div class="form">';
		$html .= '<table border="1" cellpadding="2" cellspacing="2" nobr="true" class="table-fill">';
		$html .= '<thead>';
		$html .= '<tr>';
		$html .= '<th colspan="2" align="center">Seo Issues at ' . $htmlInfo["url"] . '</th>';
		$html .= '</tr>';
		$html .= '</thead>';
		$html .= '<tbody>';
		...
		/* if($htmlInfo["dnsReachable"] !== false){ */
			...
			if( $htmlInfo["isAlive"]  == true){		
				...
				$html .= '<div style="width: 100%;"><span style=""><strong>Site Status</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				$html .= '<div style="width: 100%;"><span style="">Congratulations! Your site is alive.</span></div>';			
				$html .= '</td>';
				$html .= '</tr>';
				
				$html .= '<tr nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Title Tag</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				if(isset($htmlInfo["titletext"])){
					$html .= '<div style="width: 100%;"><span style="">The meta title of your page has a length of '.strlen($htmlInfo["titletext"]).' characters. Most search engines will truncate meta titles to 70 characters. <br> -> <strong>'.$htmlInfo["titletext"].'</strong> </span></div>';
				}else{
					$html .= '<div style="width: 100%;"><span style="">Your page doesn\'t have title. </span></div>';
				}
				$html .= '</td>';
				$html .= '</tr>';
				...
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Meta Description</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				if(isset($htmlInfo["description"])){
					$html .= '<div style="width: 100%;"><span style="">The meta description of your page has a length of '.strlen($htmlInfo["description"]).' characters. Most search engines will truncate meta descriptions to 160 characters. <br> -> <strong>'.$htmlInfo["description"].'</strong> </span></div>';
				}else{
					$html .= '<div style="width: 100%;"><span style="">Your page doesn\'t have meta description </span></div>';
				}
				$html .= '</td>';
				$html .= '</tr>';
				...
				$html .= '<tr style="width: 100%;" nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Google Search Results Preview</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				...
				$html .= '<span style="color:#006621;">'.$this->addScheme($htmlInfo["url"], "http://").'</span><br>';
				if(isset($htmlInfo["description"])){
					$html .= '<span style="color:#6A6A6A;">'.$htmlInfo["description"].'</span>';
				}
				$html .= '</div>';
				$html .= '</td>';
				$html .= '</tr>';
				...
				$html .= '<tr style="width: 100%;" nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Most Common Keywords Test</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				$html .= '<div style="width: 100%;">';
				if(!empty($htmlInfo["wordCountMax"])){
					$html .= '<span style="">There is likely no optimal keyword density (search engine algorithms have evolved beyond
					...
					foreach($htmlInfo["wordCountMax"] as $wordMaxKey => $wordMaxValue){
						$html .= '<br>-> <span style="font-weight:bold;color:#000000;">'.$wordMaxKey.' - '.$wordMaxValue.'</span>';
					}
				}else{
					$html .= '<span style="">Your page doens\'t have any repeated keywords.</span><br>';
				}
				$html .= '</div>';
				$html .= '</td>';
				$html .= '</tr>';
				...
				$html .= '<tr style="width: 100%;" nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Keyword Usage</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				$html .= '<div style="width: 100%;">';
				if(!empty($htmlInfo["compareMetaKeywords"])){
					$html .= '<span style="">Your page have common keywords from meta tags.</span>';
					foreach($htmlInfo["compareMetaKeywords"] as $metaKey => $metaValue){
						$html .= '<br>-> <span style="color:#000000;">'.$metaValue.'</span>';
					}
				}else{
					$html .= '<span style="">Your most common keywords are not appearing in one or more of the meta-tags above. Your
				...
				$html .= '<tr style="width: 100%;" nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>h1 Headings Status</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				$html .= '<div style="width: 100%;">';
				...
				$html .= '<tr style="width: 100%;" nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>h2 Headings Status</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				$html .= '<div style="width: 100%;">';
				...
				$html .= '<tr style="width: 100%;" nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Robots.txt Test</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				$html .= '<div style="width: 100%;">';
				...
				$html .= '<tr style="width: 100%;" nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Sitemap Test</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				$html .= '<div style="width: 100%;">';
				if($htmlInfo["robots"] == 200){
				...
				$html .= '<tr style="width: 100%;" nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Broken Links Test</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				$html .= '<div style="width: 100%;">';
				...
				$html .= '<tr style="width: 100%;" nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Image Alt Test</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				$html .= '<div style="width: 100%;">';
				...
				$html .= '<tr style="width: 100%;" nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Google Analytics</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				$html .= '<div style="width: 100%;">';
				...
				$html .= '<tr nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Favicon Test</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				...
				$html .= '<tr nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Site Loading Speed Test</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				...
				$html .= '<tr nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Flash Test</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				...
				$html .= '<tr nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>Frame Test</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				...
				$html .= '<tr nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>CSS Minification</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				...
				$html .= '<tr nobr="true">';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style=""><strong>JS Minification</strong></span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
				$html .= '<div style="width: 100%;font-size:10px;">';
				...
				$html .= '<tr>';
				$html .= '<td style="width: 30%;">';
				$html .= '<div style="width: 100%;"><span style="">Site Status</span></div>';
				$html .= '</td>';
				$html .= '<td style="width: 70%;">';
